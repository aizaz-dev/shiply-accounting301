...
const logos = [
    ...
    { name: 'Purolator', src: '/homepage/connectedSlider/5.png' },
    ...
    { name: 'Company 9', src: '/homepage/connectedSlider/9.png' },
    { name: 'Company 10', src: '/homepage/connectedSlider/10.png' },
    { name: 'Company 11', src: '/homepage/connectedSlider/11.png' },
    { name: 'Company 12', src: '/homepage/connectedSlider/12.png' },
